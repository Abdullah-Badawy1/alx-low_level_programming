 ...
 * Return: Pointer to the newly created hash table, or NULL if creation fails.
 */
...
/**
 * shash_sorted_list_update - Updates a sorted list in the hash table.
 ...
 */
int shash_sorted_list_update(shash_table_t **ht, shash_node_t **new_node, const char *key, const char *value)
{
...
/**
 * shash_sorted_list_insert - Inserts a node into a sorted list in the hash table.
 * @ht: Pointer to the sorted hash table.
 * @new_node: Pointer to the new node to be inserted.
 * @key: The key associated with the node.
 * Return: 1 if inserted successfully, 0 otherwise.
 */
int shash_sorted_list_insert(shash_table_t **ht, shash_node_t **new_node, const char *key)
{
	shash_node_t *old_head = NULL;
...
/**
 * shash_insert_into_sorted_list - Inserts a key-value pair into a sorted list.
 * @ht: Pointer to the sorted hash table.
 * @key: The key to be inserted.
 * @value: The value associated with the key.
 * Return: 1 if insertion is successful, 0 otherwise.
 */
int shash_insert_into_sorted_list(shash_table_t *ht, const char *key, const char *value)
{
...
/**
 * shash_insert_into_array - Inserts a key-value pair into the hash array.
 * @ht: Pointer to the sorted hash table.
 * @key: The key to be inserted.
 * @value: The value associated with the key.
 * Return: 1 if insertion is successful, 0 otherwise.
 */
int shash_insert_into_array(shash_table_t *ht, const char *key, const char *value)
{
...
/**
 * shash_table_print - Prints the contents of the hash table in order.
 * @ht: Pointer to the hash table.
 */
...
/**
 * shash_table_print_rev - Prints the contents of the hash table in reverse order.
 * @ht: Pointer to the hash table.
 */
